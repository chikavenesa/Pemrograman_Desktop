...
Public Class frmUtama
        ...
        If e.KeyCode = Keys.Return Then
           ...
           "' and waktu_keluar is null and DATE(`waktu_masuk`) = CURDATE()"
            ...
            Else 'kalau belum ada masukkan baru
               ...
               txtNoPlat.Text.ToUpper & "','" & lblInfoJenis.Text & "','" & pengguna & "')"
                If hasil1.IsClosed = False Then
                    hasil1.Close()
                End If
                myCommand.CommandText = sql
    ...
    Private Sub DaftarKendaraanToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles DaftarKendaraanToolStripMenuItem.Click
        frmLangganan.Show()
    End Sub
