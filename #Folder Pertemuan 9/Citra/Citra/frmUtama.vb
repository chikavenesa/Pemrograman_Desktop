Public Class frmUtama
    ...
    Private Sub GelapkanToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles GelapkanToolStripMenuItem.Click
        If PictureBox1.Image Is Nothing Then
            MessageBox.Show("Pilih gambar terlebih dahulu!", "Perhatian!", MessageBoxButtons.OK, MessageBoxIcon.Error)
            Return
        End If
    ...
    Private Sub FlipHorisontalToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles FlipHorisontalToolStripMenuItem.Click
        ...
        For bar As Integer = 0 To height - 1
            For kol As Integer = 0 To width - 1
                result.SetPixel(width - 1 - kol, bar, bmp.GetPixel(kol, bar))
            Next
        Next
    ...
    Private Sub GaussianBlurToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles GaussianBlurToolStripMenuItem.Click
        ...
        For bar As Integer = 1 To PictureBox1.Image.Height - 2
            For kol As Integer = 1 To PictureBox1.Image.Width - 2
                r = 0 : g = 0 : b = 0
                For i As Integer = 0 To 8
                    Dim pixel = bmp.GetPixel(kol - 1 + (i Mod 3), bar - 1 + (i \ 3))
                    r += kernel(i) * pixel.R
                    g += kernel(i) * pixel.G
                    b += kernel(i) * pixel.B
                Next
